<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="TimeCapture.aspx.cs" Inherits="TimeCapture.TimeCapture" MasterPageFile="~/Site.Master"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="navigator">
        ...
        <div id="FilterImage">
            <table cellpadding="0" cellspacing="0" align="right">
                <tr>
                    <td colspan="2"><asp:Button ID="txtbutton1" runat="server" Width="140px" Text="Filter" CssClass="TextBoxClientOverviewCenter" Enabled="false" /></td>
                </tr>
                <tr>
                    <td><asp:TextBox ID="TextBox25" runat="server" Width="80px" Text="Completed" CssClass="TextBoxClientOverviewLeft" Enabled="false" /></td>
                    <td><asp:DropDownList ID="ddlCompleted" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlCompleted_SelectedIndexChanged" CssClass="textboxgrid" >
    ...
    <div id="main">
        ...
        <br />
        <br />
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" AllowSorting="true" OnSorting="GridView2_Sorting"   
                CellPadding="4" ForeColor="#333333" GridLines="None" OnRowUpdating="GridView2_RowUpdating" CssClass="GridLayout" 
                OnRowDataBound="GridView2_RowDataBound" OnRowCommand="GridView2_RowCommand" HeaderStyle-BackColor="#DDDDDD" HeaderStyle-ForeColor="#465C71" Width="98%">
            <Columns>
                ...
                <asp:TemplateField ItemStyle-Width="1%" HeaderStyle-Width="1%">
                    <ItemTemplate>
                        <asp:Panel ID="PnlFilterHeader" runat="server" Font-Names="Segoe UI">
                            <asp:Label ID="lblFilterHeader" runat="server" /><asp:Image ID="Image1" runat="server" ImageUrl="~/Images/icon-chevron-collapsed.png" />
                        </asp:Panel>
                        <asp:Panel ID="pnlFilterBody" runat="server">
                            <asp:Label ID="lblRecordID" runat="server" Font-Names="Segoe UI" Font-Size="12px" Text='<%#Bind("EntityChangeLogId") %>' />
                        </asp:Panel>        
                        <AjaxASP:CollapsiblePanelExtender ID="CollapsiblePanelExtender1" runat="server" CollapseControlID="pnlFilterHeader" Collapsed="True" CollapsedImage="Images/icon-chevron-collapsed.png" ExpandedImage="../Images/icon-chevron-expanded.png" 
                            CollapsedText="" ExpandControlID="pnlFilterHeader" ExpandedText="" TargetControlID="pnlFilterBody" 
                ...
                <asp:TemplateField HeaderText="Incident" SortExpression="IncidentID" HeaderStyle-Width="50px" ItemStyle-Width="50px" >
                    <itemtemplate>
                        <asp:Button ID="btnIncidentID" runat="server" Text='<%#Bind("IncidentID") %>' BorderStyle="None" Font-Names="Segoe UI" BackColor="Transparent" CausesValidation="false" OnClick="btnIncidentID_Click" />
                ...
                <asp:TemplateField HeaderText=" Mins " HeaderStyle-Width="45px" ItemStyle-Width="45px" >
                    <itemtemplate>
                        <asp:TextBox ID="txtTimeInMinutesRO" runat="server" Text='<%#Bind("TimeInMinutes") %>' CssClass="centertextboxgrid" Visible="true" />
                    </itemtemplate>
                ...
                <asp:TemplateField HeaderText=" Cat " HeaderStyle-Width="75px" ItemStyle-Width="75px" >
                    <itemtemplate>
                        <asp:TextBox ID="txtCategory" runat="server" Text='<%#Bind("Category") %>' CssClass="centertextboxgrid" ReadOnly="true" Visible="true" />
                    </itemtemplate>
                ...
                <asp:TemplateField HeaderText=" Sub " HeaderStyle-Width="75px" ItemStyle-Width="75px" >
                    <itemtemplate>
                        <asp:TextBox ID="txtSubCategory" runat="server" Text='<%#Bind("SubCategory") %>' CssClass="centertextboxgrid" ReadOnly="true" Visible="true" />
                    </itemtemplate>
                    <headerstyle wrap="False" Font-Names="Segoe UI"/>
                    <itemstyle horizontalalign="Center" />
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Comments" HeaderStyle-Width="40%" ItemStyle-Width="40%" >
                    <itemtemplate>
                ...
                <asp:TemplateField HeaderText="AHS" HeaderStyle-Width="2%" ItemStyle-Width="2%" ItemStyle-HorizontalAlign="Center" >
                    <itemtemplate>
                        <asp:CheckBox ID="cbAHS" runat="server" Checked='<%#Bind("AHS") %>'   />
                    </itemtemplate>
                    <headerstyle wrap="False" Font-Names="Segoe UI"/>
                </asp:TemplateField>  
                <asp:TemplateField HeaderText="Done" HeaderStyle-Width="2%" ItemStyle-Width="2%" ItemStyle-HorizontalAlign="Center" >
                    <itemtemplate>
                        <asp:CheckBox ID="cbCompleted" runat="server" Checked='<%#Bind("Completed") %>'   />
                    </itemtemplate>
                    <headerstyle wrap="False" Font-Names="Segoe UI"/>
                </asp:TemplateField>
